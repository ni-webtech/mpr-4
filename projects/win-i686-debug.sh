...
"link" -out:${PLATFORM}/bin/testMpr.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${PLATFORM}/obj/testArgv.obj ${PLATFORM}/obj/testBuf.obj ${PLATFORM}/obj/testCmd.obj ${PLATFORM}/obj/testCond.obj ${PLATFORM}/obj/testEvent.obj ${PLATFORM}/obj/testFile.obj ${PLATFORM}/obj/testHash.obj ${PLATFORM}/obj/testList.obj ${PLATFORM}/obj/testLock.obj ${PLATFORM}/obj/testMem.obj ${PLATFORM}/obj/testMpr.obj ${PLATFORM}/obj/testPath.obj ${PLATFORM}/obj/testSocket.obj ${PLATFORM}/obj/testSprintf.obj ${PLATFORM}/obj/testThread.obj ${PLATFORM}/obj/testTime.obj ${PLATFORM}/obj/testUnicode.obj ${PLATFORM}/bin/libws2_32.lib ${PLATFORM}/bin/libadvapi32.lib ${PLATFORM}/bin/libuser32.lib ${PLATFORM}/bin/libkernel32.lib ${PLATFORM}/bin/liboldnames.lib ${PLATFORM}/bin/libmsvcrt.lib ${PLATFORM}/bin/libmpr.lib

"${CC}" -c -Fo${PLATFORM}/obj/manager.obj -Fd${PLATFORM}/obj ${CFLAGS} ${DFLAGS} -I${PLATFORM}/inc src/manager.c

"link" -out:${PLATFORM}/bin/manager.exe -entry:WinMainCRTStartup -subsystem:Windows ${LDFLAGS} ${PLATFORM}/obj/manager.obj ${PLATFORM}/bin/libws2_32.lib ${PLATFORM}/bin/libadvapi32.lib ${PLATFORM}/bin/libuser32.lib ${PLATFORM}/bin/libkernel32.lib ${PLATFORM}/bin/liboldnames.lib ${PLATFORM}/bin/libmsvcrt.lib ${PLATFORM}/bin/libmpr.lib shell32.lib
...
"link" -out:${PLATFORM}/bin/chargen.exe -entry:mainCRTStartup -subsystem:console ${LDFLAGS} ${PLATFORM}/obj/charGen.obj ${PLATFORM}/bin/libws2_32.lib ${PLATFORM}/bin/libadvapi32.lib ${PLATFORM}/bin/libuser32.lib ${PLATFORM}/bin/libkernel32.lib ${PLATFORM}/bin/liboldnames.lib ${PLATFORM}/bin/libmsvcrt.lib ${PLATFORM}/bin/libmpr.lib
