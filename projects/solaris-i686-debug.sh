...
${CC} -c -o solaris-i686-debug/obj/benchMpr.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/benchMpr.c

${CC} -o solaris-i686-debug/bin/benchMpr ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/benchMpr.o ${LIBS} -lmpr -g -ldl

${CC} -c -o solaris-i686-debug/obj/runProgram.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/runProgram.c

${CC} -o solaris-i686-debug/bin/runProgram ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/runProgram.o ${LIBS} -g -ldl

${CC} -c -o solaris-i686-debug/obj/testArgv.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testArgv.c

${CC} -c -o solaris-i686-debug/obj/testBuf.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testBuf.c

${CC} -c -o solaris-i686-debug/obj/testCmd.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testCmd.c

${CC} -c -o solaris-i686-debug/obj/testCond.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testCond.c

${CC} -c -o solaris-i686-debug/obj/testEvent.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testEvent.c

${CC} -c -o solaris-i686-debug/obj/testFile.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testFile.c

${CC} -c -o solaris-i686-debug/obj/testHash.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testHash.c

${CC} -c -o solaris-i686-debug/obj/testList.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testList.c

${CC} -c -o solaris-i686-debug/obj/testLock.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testLock.c

${CC} -c -o solaris-i686-debug/obj/testMem.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testMem.c

${CC} -c -o solaris-i686-debug/obj/testMpr.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testMpr.c

${CC} -c -o solaris-i686-debug/obj/testPath.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testPath.c

${CC} -c -o solaris-i686-debug/obj/testSocket.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testSocket.c

${CC} -c -o solaris-i686-debug/obj/testSprintf.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testSprintf.c

${CC} -c -o solaris-i686-debug/obj/testThread.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testThread.c

${CC} -c -o solaris-i686-debug/obj/testTime.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testTime.c

${CC} -c -o solaris-i686-debug/obj/testUnicode.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/test/testUnicode.c

${CC} -o solaris-i686-debug/bin/testMpr ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/testArgv.o solaris-i686-debug/obj/testBuf.o solaris-i686-debug/obj/testCmd.o solaris-i686-debug/obj/testCond.o solaris-i686-debug/obj/testEvent.o solaris-i686-debug/obj/testFile.o solaris-i686-debug/obj/testHash.o solaris-i686-debug/obj/testList.o solaris-i686-debug/obj/testLock.o solaris-i686-debug/obj/testMem.o solaris-i686-debug/obj/testMpr.o solaris-i686-debug/obj/testPath.o solaris-i686-debug/obj/testSocket.o solaris-i686-debug/obj/testSprintf.o solaris-i686-debug/obj/testThread.o solaris-i686-debug/obj/testTime.o solaris-i686-debug/obj/testUnicode.o ${LIBS} -lmpr -g -ldl

${CC} -c -o solaris-i686-debug/obj/manager.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/manager.c

${CC} -o solaris-i686-debug/bin/manager ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/manager.o ${LIBS} -lmpr -g -ldl

${CC} -c -o solaris-i686-debug/obj/makerom.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/utils/makerom.c

${CC} -o solaris-i686-debug/bin/makerom ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/makerom.o ${LIBS} -lmpr -g -ldl

${CC} -c -o solaris-i686-debug/obj/charGen.o ${CFLAGS} ${DFLAGS} -Isrc -Isolaris-i686-debug/inc src/utils/charGen.c

${CC} -o solaris-i686-debug/bin/chargen ${LDFLAGS} -Lsolaris-i686-debug/lib solaris-i686-debug/obj/charGen.o ${LIBS} -lmpr -g -ldl
