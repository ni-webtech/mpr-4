 ...
 */
MprChar *itow(MprChar *buf, MprSize count, int64 value, int radix)
{
    MprChar     numBuf[32];
    MprChar     *cp, *dp, *endp;
...
MprChar *wcontains(MprChar *str, MprChar *pattern, MprSize limit)
{
    MprChar     *cp, *s1, *s2;
    MprSize      lim;
 ...
 */
MprSize wcopy(MprChar *dest, MprSize destMax, MprChar *src)
{
    MprSize      len;
 ...
 */
uint whash(MprChar *name, MprSize len)
{
    uint    tmp, rem, hash;
...
uint whashlower(MprChar *name, MprSize len)
{
    uint    tmp, rem, hash;
...
int wncasecmp(MprChar *s1, MprChar *s2, MprSize n)
{
    int     rc;
...
int wncmp(MprChar *s1, MprChar *s2, MprSize n)
{
    int     rc;
...
/*
    ...
    destMax and len are character counts, not sizes in bytes
 */
MprSize wncopy(MprChar *dest, MprSize destMax, MprChar *src, MprSize count)
{
    MprSize      len;
...
MprSize wspn(MprChar *str, MprChar *set)
{
    MprChar     *sp;
    int         count;
...
MprChar *wsub(MprChar *str, MprSize offset, MprSize len)
{
    MprChar    *result;
    MprSize      size;
 ...
 */
MprSize wtom(char *dest, MprSize destCount, MprChar *src, MprSize len)
{
    MprSize      size;
...
/*
    ...
    NOTE: does not allocate
 */
MprSize mtow(MprChar *dest, MprSize destCount, cchar *src, MprSize len) 
{
    MprSize      size;
...
MprChar *amtow(cchar *src, MprSize *lenp)
{
    MprChar     *dest;
    MprSize      len;
...
char *awtom(MprChar *src, MprSize *lenp)
{
    char    *dest;
    MprSize  len;
...
MprSize xmtow(MprChar *dest, MprSize destMax, cchar *src, MprSize len) 
{
    MprChar     *dp, *dend;
    cchar       *sp, *send;
    int         i, c, count;
...
MprSize xwtom(char *dest, MprSize destMax, MprChar *src, MprSize len)
{
    MprChar     *sp, *send;
    char        *dp, *dend;
...
MprChar *amtow(cchar *src, MprSize *len)
{
    if (len) {
        *len = strlen(src);
    }
...
char *awtom(MprChar *src, MprSize *len)
{
    if (len) {
        *len = strlen(src);
    }
